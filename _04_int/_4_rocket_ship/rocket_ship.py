...
def mouse_pressed(event):
    ...
    canvas.create_oval(x-150, y+100, x + 150, y+350, fill="red", outline="")
    canvas.create_oval(x-110, y+100, x + 100, y+246, fill="orange", outline="")
    canvas.create_oval(x-100, y+100, x + 100, y+200, fill="yellow", outline="")
